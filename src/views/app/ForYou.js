    ...
    if (inProgress.length > 0 || recentlyWatched.length > 0) {
      ...
      return (
        <div className="ForYou">
          <h2>Get started</h2>
          <p>
            To watch your movies and TV shows, you first have to sign in with
            the cloud service that hosts your media.
          </p>
      ...
      return (
        <div className="ForYou">
          <h2>Get started</h2>
          <p>
            You signed into a cloud service, but we didn&apos;t find any movies
            or TV shows.
          </p>
          <p>
            It&apos;s likely that you just have to move some of your files
            around and create some folders to make it work.
          </p>
          <p>
